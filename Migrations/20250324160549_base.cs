        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoice_Client_ClientesModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceModelId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceDetail_Invoice_InvoiceModelId",
                        column: x => x.InvoiceModelId,
                        principalTable: "Invoice",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceDetail_Productos_ProductModelId",
                        column: x => x.ProductModelId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceDetail_Stock_StockModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoice_ClientesModelId",
                table: "Invoice",
                column: "ClientesModelId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetail_InvoiceModelId",
                table: "InvoiceDetail",
                column: "InvoiceModelId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetail_ProductModelId",
                table: "InvoiceDetail",
                column: "ProductModelId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetail_StockModelId",
                table: "InvoiceDetail",
                column: "StockModelId");
